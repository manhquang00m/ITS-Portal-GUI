    ...
    <Box pt={{ base: "130px", md: "80px", xl: "80px" }}>
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent p={4} minWidth={"80%"}>
          ...
          <ModalCloseButton  />
          <ModalBody>
            <AfterClassCanvas data={getValues()} ref={childRef}></AfterClassCanvas>
          </ModalBody>
          <ModalFooter>
            <Button variant="setup" onClick={onClose}>
              Đóng
            </Button>
            <Button  mx={3} variant="brandOutline">Chia sẻ</Button>
            <Button onClick={handleButtonClick} variant="brand">Tải ảnh xuống</Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
    </Box>
